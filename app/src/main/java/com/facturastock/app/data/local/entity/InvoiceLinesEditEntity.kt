...
/** Último snapshot agregado del editor de líneas para un borrador. */
@Entity(
    tableName = "invoice_line_edits",
    foreignKeys = [
        ForeignKey(
...
data class InvoiceLinesEditEntity(
    ...
    init {
        ...
        require(payload.isNotEmpty() && payload.size <= InvoiceLinesEditCodec.MAX_PAYLOAD_BYTES) {
            "Tamaño de editor de líneas inválido: ${payload.size}"
        }
    ...
    override fun equals(other: Any?): Boolean =
        this === other ||
            other is InvoiceLinesEditEntity &&
