...
class PurchaseSummaryScreenTest {
    ...
    fun preparedSummaryShowsFrozenSnapshotAndBothExplicitActions() {
        ...
        composeRule.onNodeWithText(context.getString(R.string.summary_action_register))
            .assertIsDisplayed()
        composeRule.onNodeWithText(context.getString(R.string.summary_action_reopen))
            .assertIsDisplayed()
    }
    ...
    fun missingSalePriceBlockerExplainsAffectedLine() {
        ...
        composeRule.onNodeWithText(
            context.getString(R.string.summary_blocker_line_sale_price_required, 3),
        ).assertIsDisplayed()
