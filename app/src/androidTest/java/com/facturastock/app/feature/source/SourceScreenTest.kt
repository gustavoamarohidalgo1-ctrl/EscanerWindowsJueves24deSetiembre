...
class SourceScreenTest {
    ...
    fun bothSourceActionsAndThePrivacyCardAreVisible() {
        ...
        composeRule
            ...
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(context.getString(R.string.source_privacy_title))
            .assertIsDisplayed()
        composeRule
        ...
        composeRule
            ...
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(context.getString(R.string.action_take_photo))
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(context.getString(R.string.action_pick_image))
            .assertIsDisplayed()
    }
    ...
    fun invalidImageCardShowsItsReasonAndDismisses() {
        ...
        composeRule
            ...
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(context.getString(R.string.source_invalid_image_too_large))
            .assertIsDisplayed()
        composeRule
