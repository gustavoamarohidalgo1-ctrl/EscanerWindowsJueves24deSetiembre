...
class InvoiceHeaderReviewScreenTest {
    ...
    fun lowConfidenceUsesVisibleTextAndTalkBackStateDescription() {
        val lowText = context.getString(R.string.header_review_low_confidence)
    ...
    fun evidenceActionShowsExactOcrTextPageAndAlternatives() {
        ...
        composeRule.onNodeWithText(
            context.getString(R.string.header_review_evidence_page, 1),
        ).assertIsDisplayed()
        composeRule.onNodeWithText(
            context.getString(
        ...
        composeRule.onNodeWithText(context.getString(R.string.header_review_close)).performClick()
    ...
    fun documentThumbnailIsNamedClickableAndOpensTheExpandableDocument() {
        ...
        val description = context.getString(R.string.header_review_expand_page_description, 1)
        composeRule
        ...
        composeRule
            ...
            .assert(
                SemanticsMatcher.expectValue(
                    ...
                    context.getString(R.string.header_review_expanded_page_title, 1),
                ),
            )
            .assert(
                SemanticsMatcher.expectValue(
    ...
    fun requiredErrorIsDeferredUntilContinueAndCtaExplainsTheCorrection() {
        ...
        val error = context.getString(R.string.header_review_error_required)
        composeRule.setContent {
            FacturaStockTheme {
                InvoiceHeaderReviewScreen(
                    state = state,
        ...
        composeRule.onNodeWithText(
            context.getString(
                ...
                context.getString(R.string.header_review_ruc_label),
            ),
        ).assertIsDisplayed()
    }
    ...
    fun reviewProductsActionRemainsVisibleWhenTheDecimalKeyboardIsRequested() {
        ...
        // La barra está fuera del LazyColumn y el root aplica imePadding: al pedir el teclado la
        // acción sigue dentro del área visible, en lugar de quedar detrás del IME.
        composeRule
            .onNodeWithTag(InvoiceHeaderReviewTestTags.REVIEW_PRODUCTS)
            .assertIsDisplayed()
            .assertHasClickAction()
