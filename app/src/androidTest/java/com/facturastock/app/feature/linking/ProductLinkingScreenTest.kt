...
class ProductLinkingScreenTest {
    ...
    fun candidatesShowTheirReasonAndLinkingEmitsTheConfirmation() {
        ...
        composeRule.onNodeWithText(
            context.getString(R.string.linking_reason_similar_name),
        ).assertIsDisplayed()
        ...
        composeRule.onNodeWithText(
            context.getString(R.string.linking_status_confirmed),
        ).assertIsDisplayed()
    ...
    fun failedSearchHidesPreviousCandidatesAndOffersRetry() {
        ...
        composeRule.onNodeWithText(
            context.getString(R.string.linking_search_error_message),
        ).assertIsDisplayed()
        composeRule
    ...
    fun skipLeavesTheLinePendingWithoutContinuing() {
        ...
        composeRule.onNodeWithText(
            context.getString(R.string.linking_no_candidates),
        ).assertIsDisplayed()
        composeRule.onNodeWithTag(ProductLinkingTestTags.SKIP).performClick()
        composeRule.onNodeWithText(
            context.getString(R.string.linking_status_skipped),
        ).assertIsDisplayed()
        composeRule.onNodeWithTag(ProductLinkingTestTags.CONTINUE).assertIsEnabled()
    }
    ...
    fun createDialogValidatesTheFormAndReportsChanges() {
        ...
        composeRule.onNodeWithText(
            context.getString(R.string.linking_create_error_unit),
        ).assertIsDisplayed()
    ...
    fun validNewProductSelectionCreatesAndLinksWithoutLeavingTheReview() {
        ...
        composeRule.onAllNodesWithText(
            context.getString(R.string.linking_linked_to, "Galleta Sorpresa"),
        ).assertCountEquals(2)
        composeRule.onNodeWithTag(ProductLinkingTestTags.CONTINUE).assertIsEnabled()
    }
