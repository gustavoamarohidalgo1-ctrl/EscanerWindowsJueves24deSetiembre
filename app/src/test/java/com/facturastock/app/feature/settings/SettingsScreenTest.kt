...
class SettingsScreenTest {
    ...
    fun showsOnlyBusinessProfileTaxAndDataExport() {
        ...
        composeRule.onNodeWithText(str(Res.string.settings_section_business))
            .assertIsDisplayed()
        composeRule.onNodeWithText(str(Res.string.settings_section_tax))
            .performScrollTo()
            .assertIsDisplayed()
        composeRule.onNodeWithText(str(Res.string.settings_section_data))
            .performScrollTo()
            .assertIsDisplayed()
    ...
    fun uncleanExportDestinationShowsManualDeletionWarning() {
        ...
        composeRule.onNodeWithText(str(Res.string.settings_export_partial_title))
            .performScrollTo()
            .assertIsDisplayed()
        composeRule.onNodeWithText(str(Res.string.settings_export_partial_message))
            .assertIsDisplayed()
    }
