...
/**
 * Reemplazo de [AppConfigurationModule] en [TestAppComponent]: la compuerta de primer inicio se
 * controla fijando [TestAppConfigurationState.current] ANTES de montar la aplicación. El fake
 * delega en ese MutableStateFlow compartido, así funciona aunque varios grafos convivan en el
 * mismo proceso de tests.
 */
@Module
