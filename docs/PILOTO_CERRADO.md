...
- Anteponer `[DEMO]` a cada entidad creada y salir del modo demostración al terminar.
...
- Instalar el candidato `cloud` desde la pista interna de Play con una cuenta de prueba verificada y
  rol OWNER o ADMIN. El AVD y una instalación por ADB sirven para diagnóstico, no cierran este piloto.

## Guion de 21 pasos

| # | Acción | Resultado esperado |
| --- | --- | --- |
| 1 | Instalar desde pista interna y abrir | Onboarding visible; versión y firma corresponden al candidato |
| 2 | Activar modo demostración | Aviso permanente de modo demo |
| 3 | Abrir la factura demo de 38 líneas | Captura/importación y OCR local inician sin datos reales |
...
| 16 | Reconectar | Drena una vez y conserva idempotencia |
| 17 | Provocar conflicto controlado | Muestra `CONFLICT` y permite resolver sin borrar el libro local |
| 18 | Vencer sesión durante drenado | Refresca/reintenta una vez; si no recupera, conserva cola y pide reingreso |
...
| 21 | Salir del modo demostración | Elimina solo los datos demo y deja intacta cualquier información ajena al piloto |
...
| Instalación desde pista interna | NO CUMPLE | Faltan firma/configuración productivas y acceso a Play Console |
...
| Artefacto | `versionName`, `versionCode`, SHA-256 y pista |
